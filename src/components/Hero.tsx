            ...
            <div style={{
                ...
                <div style={{ flex: '1 1 500px' }}>
                    ...
                    <p style={{
                        ...
                        Je conçois des applications web évolutives, visuellement captivantes et performantes. 
                        Je transforme des problèmes complexes en solutions élégantes et centrées sur l'utilisateur.
                    </p>
                ...
                <div style={{ flex: '1 1 400px', display: 'flex', justifyContent: 'center' }}>
                    <div style={{
                        ...
                        <Image
                            src="/profile.png"
                            alt="Rodin - Développeur Full-Stack"
                            fill
